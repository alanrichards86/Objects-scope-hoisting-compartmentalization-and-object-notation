...
/**************************************************************************************
------------ ANSWER -------------------
Inside the function console.log(add); will add 2 + 2 and log 4.
Outside the function console.log(add); will return an error. I don't remember the type of error but that is what I believe it to be.
